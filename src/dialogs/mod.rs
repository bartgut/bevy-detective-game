...
impl Plugin for DialogsPlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(Dialogs::load_from_file("assets/dialogs/first_dialog.yarn", "Librarian1PlayerConversationIntro"))
            ...
            .add_system(mouse_button_input.after(interact_with_dialog_text).run_if(in_state(InGameState::Dialog)));
    }
}